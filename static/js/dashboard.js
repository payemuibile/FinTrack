...
async function loadTrendChart() {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                { label: 'Income', data: data.map(d => d.income), backgroundColor: 'rgba(25, 135, 84, 0.8)', borderRadius: 6 },
                { label: 'Expenses', data: data.map(d => d.expenses), backgroundColor: 'rgba(220, 53, 69, 0.8)', borderRadius: 6 }
            ]
        },
        options: {
            responsive: true,
